...
**Đường dẫn**: `src/modules/Auth/Login.jsx`

## 1. Nhiệm Vụ Cốt Lõi (Responsibilities)
- Quản lý và phát triển các tính năng độc lập thuộc module Login.
...
- [2026-09-16] Cải thiện thông báo lỗi khi đăng nhập Google thất bại (đặc biệt xử lý lỗi `auth/unauthorized-domain` do chưa whitelist domain trên Firebase).
